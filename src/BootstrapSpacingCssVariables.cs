...
/// </summary>
public sealed class BootstrapSpacingCssVariables
{
    // Grid Gutters
    /// <summary>
    /// Gutter X. Default: 1.5rem
    /// </summary>
    [CssVariable("bs-gutter-x")]
    public string? GutterX { get; set; }

    /// <summary>
    /// Gutter Y. Default: 0
    /// </summary>
    [CssVariable("bs-gutter-y")]
    ...
    /// </summary>
    [CssVariable("bs-container-padding-x")]
    public string? ContainerPaddingX { get; set; }

    /// <summary>
    /// Container padding Y. Default: 0
    /// </summary>
    [CssVariable("bs-container-padding-y")]
